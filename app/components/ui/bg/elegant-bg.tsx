...
export function DarkGradientBg({ children, className }: DarkGradientBgProps) {
  return (
    <div className="relative min-h-screen w-full bg-[#1565C0] overflow-hidden">
      <div className="absolute inset-0">
        <div
          className="absolute inset-0 opacity-100"
          style={{
            background: 'radial-gradient(100% 100% at 0% 0%, #1976D2 0%, #0D47A1 100%)',
        ...
        >
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(#BBDEFB 0%, rgba(187, 222, 251, 0) 100%)',
